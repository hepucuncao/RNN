...
def train(trainloader, testloader, model='rnn',
    ...
    if model == 'fc':
        ...
        net = SimpleRNN(height, width, hidden_size, output_size)
        #net = SimpleRNN(input_size=fc_dim_in, hidden_size=fc_dim_hidden, output_size=fc_dim_out)
    else:
